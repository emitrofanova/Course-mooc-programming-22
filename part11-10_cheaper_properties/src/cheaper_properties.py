...
def cheaper_properties(properties: list, reference: RealProperty):
    return [(apart, reference.price_per_sqm * reference.square_meters - apart.price_per_sqm * apart.square_meters) for apart in properties if apart.price_per_sqm * apart.square_meters < reference.price_per_sqm * reference.square_meters]
